...
-- ВРЕМЕННАЯ СЛОЖНОСТЬ --
 O(n log n) но константна меньше чем у сортировки слиянием.

-- ПРОСТРАНСТВЕННАЯ СЛОЖНОСТЬ --
 O(n) для хранения массива
 + (log n) дополнительной памяти при вызове MaxHeapify в случае если нужно просеять корень до листа поскольку MaxHeapify рекурсивна.
